...
def evaluate_v2():
    ...
    print(f"Evaluating {len(golden['queries'])} V2 queries...")
    ...
    for q in tqdm(golden['queries']):
        ...
        for chunk in search_res.context_chunks:
             chunks.append({
                 ...
                 "score": 0.0 # Score usually not exposed in SearchResult chunk list directly unless custom model
             })
    ...
    output_dir = Path('tests/accuracy_tuning_output_v2')
