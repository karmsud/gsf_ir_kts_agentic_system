...
"""
PyInstaller spec file for KTS Backend — Option A3 (Word + Images)
Builds a onedir distribution for Windows x64
Excludes: PyMuPDF (PDF), python-pptx (PPTX), Pillow
"""
...
backend_hidden_imports = [
    ...
    # pdf_converter — kept in source but fitz unavailable at runtime
    # pptx_converter — kept in source but pptx unavailable at runtime
...
# Add common dependencies — A3 subset (no fitz, pptx)
...
a = Analysis(
    ...
    excludes=[
        ...
        'networkx',
        'chromadb',
        # A3-specific exclusions — these packages are not installed
        'fitz',
        'pymupdf',
        'pptx',
        'PIL',
